  ...
  return (
    <main className="overflow-x-hidden">
      ...
      <section className="min-h-screen w-screen bg-[#FEF7F1]">
        <div className="mx-auto max-w-7xl px-4 pt-16 sm:px-6 lg:px-8 flex flex-col md:flex-row items-stretch justify-between">
          {/* LEFT COLUMN */}
          <div className="flex flex-col justify-between max-w-full min-h-screen md:w-1/2">
            <div className="space-y-8">
              <h2 className="text-[80px] font-[600] tracking-tight leading-20 capitalize">
                Sirtifai SPP – Learn. Earn. Get Placed. Rise.
              </h2>

              <div className="flex items-center gap-8">
                <div className="flex items-center gap-4 max-w-[250px] bg-[#284050] border border-[rgba(255,255,255,0.45)] rounded-full px-4 py-2">
                ...
                <span className="text-[18px] font-[400] text-black/40 max-w-[370px]">
            ...
            <div className="flex flex-col gap-8 justify-start mb-8">
              <h3 className="text-[21px] font-inter font-[400]">
                Join SPP Now
              </h3>
              <div className="flex flex-row gap-4 items-center">
                <button className="flex items-center gap-4 bg-white shadow-[0 4px 4px 0 rgba(248, 177, 150, 0.10)] p-4 text-[#FC4C03]">
                  SPP INT <ArrowRight />
                </button>
                <button className="flex items-center gap-4 bg-white shadow-[0 4px 4px 0 rgba(248, 177, 150, 0.10)] p-4 text-[#FC4C03]">
          ...
          {/* RIGHT COLUMN */}
          <div className="max-w-[500px] min-h-screen w-full md:w-1/2">
            <img
      ...
      {/* about */}
      <section className="min-h-screen w-full flex flex-col justify-center items-center space-y-6 max-w-7xl mx-auto">
        <span className="text-[#FC4C03] font-[21px] tracking-wider text-center w-full">
          What Is SPP ?
        </span>
        <h1 className="text-[60px] font-[600] text-black capitalize">
          Our Three-Phase Approach
        </h1>
        <span className="text-[#4B5563] self-stretch max-w-3xl text-lg font-[400] mx-auto text-center">
        ...
        <div className="flex flex-col md:flex-row gap-8 mt-24">
          <div className="flex items-center flex-col justify-center">
            ...
            />
            <h1 className="text-[#1F2937] text-2xl font-[600] my-4">SKILL</h1>
            <p className="text-[#4B5563] text-base font-[400] text-center">
              Build industry-relevant skills through <br />
          ...
          <div className="flex items-center flex-col justify-center">
            <img
              ...
              className="w-16 h-16  object-cover"
            />
            <h1 className="text-[#1F2937] text-2xl font-[600] my-4">
              PRACTICE
            </h1>
            <p className="text-[#4B5563] text-base font-[400] text-center">
              Work on real client projects and earn <br />
          ...
          <div className="flex items-center flex-col justify-center">
            ...
            <p className="text-[#4B5563] text-base font-[400] text-center">
              Secure job placement and receive <br />
              ongoing career support for continued growth
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="min-h-screen w-screen bg-[#FEF7F1]">
        <div className="flex flex-col justify-center items-center max-w-7xl mx-auto min-h-screen w-screen">
          ...
          <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 mt-24 justify-between">
            {/* students */}
      ...
      {/* features */}
      <section className="min-h-[450px] w-full flex flex-col items-center justify-center">
        <h1 className="text-[60px] font-[600] text-black capitalize">
          What makes SPP Unique
        </h1>
        <div className="flex flex-row md:gap-16 items-center gap-4 mt-24">
          {/* card */}
      ...
      {/* pricing */}
      <section className="min-h-screen w-screen bg-[#FEF7F1] py-4 md:py-16">
        <div className="max-w-7xl mx-auto flex flex-col items-center gap-8  justify-center min-h-screen w-screen">
          ...
          <div className="py-2 rounded-full border-1 border-[rgba(252, 76, 3, 0.45)] p-2 bg-white mt-4 md:mt-8 space-x-4 md:space-x-8">
            <button className="bg-[#FE7642] rounded-[68px] p-2 px-4 text-white font-[600] text-lg">
              Skill Phase
            </button>
            <button className="bg-[#CAC6C6] rounded-[68px] p-2 px-4 text-white font-[600] text-lg">
              Practice Phase
            </button>
            <button className="bg-[#CAC6C6] rounded-[68px] p-2 px-4 text-white font-[600] text-lg">
              Progress Phase
          ...
          <div
            id="pricing"
            className="w-[1100px]  mx-auto relative rounded-[21px] bg-[#FEB092] shadow-[0 1.443px 9.238px 0 rgba(255, 255, 255, 0.10)]"
          >
            ...
            <div className="z-[50] broder-1 border-[#E5E7EB] p-4 md:p-6 bg-white max-w-4xl mx-auto rounded-2xl shadow-md mt-4 md:my-12">
              <div className="w-full flex items-start justify-between">
                <div>
                  <h2 className="text-[40px] font-[600] text-black capitalize">
                    Skill phase
                  </h2>
                  <p className="text-[#4B5563] text-base">
                ...
                <button className="text-[#FF7847] bg-[#FFF2EC] p-2 rounded-full">
                  Single payment
                </button>
              </div>
              ...
              <div className="flex items-center w-full justify-between">
                <div className="flex items-center gap-2">
                  <h1 className="text-[#111827] text-[36px] font-[700]">
                    ₹ 5999
                  </h1>
                  <span className="text-[#6B7280] font-[400] text-lg">
                    (one time payment)
                  </span>
                </div>
                <div className="flex items-center gap-2">
                  ...
                  />
                  <span className="text-lf font-[500]">Required</span>
                </div>
              </div>
              <div className="flex items-center w-full justify-between my-4">
                <div className="flex items-center gap-2">
                  <svg
                    ...
                    fill="none"
                  >
                    <g clip-path="url(#clip0_406_6926)">
                      <path
                        d="M20.4649 4.88725C21.0287 5.45112 21.0287 6.36683 20.4649 6.93069L8.91694 18.4786C8.35307 19.0425 7.43736 19.0425 6.87349 18.4786L1.09953 12.7047C0.53567 12.1408 0.53567 11.2251 1.09953 10.6612C1.6634 10.0974 2.57911 10.0974 3.14297 10.6612L7.89747 15.4112L18.4259 4.88725C18.9898 4.32339 19.9055 4.32339 20.4694 4.88725H20.4649Z"
                        fill="#22C55E"
                      />
                    </g>
                    <defs>
                      <clipPath id="clip0_406_6926">
                        <path
                          d="M0.679993 0.133545H20.8889V23.2294H0.679993V0.133545Z"
                          fill="white"
                        />
                      </clipPath>
                    </defs>
                  </svg>
                  <p className="text-lf font-[400]">Core skill development</p>
                </div>
                <div className="flex items-center gap-2">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  <p className="text-lf font-[400]">Learning Materials</p>
                </div>
              </div>
              <div className="flex items-center w-full justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <p className="text-lf font-[400]">Foundational Knowledge</p>
                </div>
                <div className="flex items-center gap-2">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  <p className="text-lf font-[400]">Core Tracking progress</p>
                </div>
              </div>

              <div className=" max-w-2xl mx-auto mt-4 md:mt-8">
                <button className="w-full text-white bg-[#FE7642] rounded-full py-2 px-3">
                  Buy Now
                </button>
              </div>
            </div>
      ...
      <section className="min-h-screen w-screen flex flex-col justify-center items-center">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 gap-4 md:gap-8 sm:grid-cols-3 md:grid-cols-3 mt-8 sm:mt-12 md:mt-16">
          {/* card 1 */}
          <div className="w-full rounded-[12px] shadow-[0 4px 6px 0 rgba(0, 0, 0, 0.10), 0 10px 15px 0 rgba(0, 0, 0, 0.10)] bg-white border-1 border-[#E5E7EB]">
          ...
          <div className="w-full rounded-[12px] shadow-[0 4px 6px 0 rgba(0, 0, 0, 0.10), 0 10px 15px 0 rgba(0, 0, 0, 0.10)] bg-white border-1 border-[#E5E7EB]">
            ...
            <div className="p-2 space-y-4">
              ...
              <h2 className="text-[#FE7743] font-[700]">₹3999</h2>
              <hr className="w-full bg-[#E5E7EB]" />
